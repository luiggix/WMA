...
def build_gwf_1D(mesh, tm_par, ph_par, ml_units, os_par, oc_par):
    ...
    sim = flopy.mf6.MFSimulation(sim_name=os_par["flow_name"], 
                                 sim_ws=os_par["ws"], 
    ...
    flopy.mf6.ModflowGwfoc(gwf,
                           ...
                           budget_filerecord=oc_par["hbudget_file"],
...
if __name__ == '__main__':
    ...
    ph_par = dict(specific_discharge = 0.1,  # Specific discharge ($cm s^{-1}$)
    ...
    oc_par = dict(head_file = f"{os_par['flow_name']}.hds", 
